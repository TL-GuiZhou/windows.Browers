...
using static MiniBlink.Core.BlinkBrowserPInvoke;

namespace Hbd.BlinkBrowser
{
    public class BlinkBrowser : Control, IMessageFilter
    {
        ...
        wkeDownloadFileCallback _wkeDownloadCallback;
        ...
        {
            Console.WriteLine("OnwkeDownloadCallback" + (url));
            return false;
        }
        ...
        void OnTitleChangedCallback(IntPtr webView, IntPtr param, IntPtr title)
        {
            ...
            {
                OnTitleChangeCall(BlinkBrowserPInvoke.wkeGetString(title).Utf8IntptrToString());
            }
        }
        ...
        public void CreateCore()
        {
           ...
           //  BlinkBrowserPInvoke.wkeOnDownloadFile(this.handle, _wkeDownloadFileCallback, IntPtr.Zero);
        ...
        public float ZoomFactor
        {
            get
            {
                ...
                return BlinkBrowserPInvoke.wkeGetZoomFactor(this.handle);
            }
            set
            {
                ...
                if (this.handle != IntPtr.Zero)
                {
                    BlinkBrowserPInvoke.wkeSetZoomFactor(this.handle, value);
                }
            }
        }
